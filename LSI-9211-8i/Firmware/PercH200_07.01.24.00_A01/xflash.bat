...
ECHO บ                                                                   บ
ECHO บ Dell PERC H200 controller                                         บ
ECHO บ                                                                   บ
ECHO บ This executable will update the firmware package of your Dell     บ
ECHO บ PERC H200 controller to version %PkgVer%                       บ
ECHO บ                                                                   บ
...
ECHO.
ECHO Searching for compatible PERC H200 controllers on the system...
ECHO.
...
ECHO ************************************************************
ECHO   %NumFlashed%  PERC H200 controller(s) successfully flashed
ECHO ************************************************************
ECHO.
GOTO END
...
ECHO.
ECHO **********************************************************
ECHO No compatible PERC H200 controllers were identified or 
