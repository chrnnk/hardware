...
ECHO บ                                                                   บ
ECHO บ Dell 6Gbps SAS HBA                                                บ
ECHO บ                                                                   บ
ECHO บ This executable will update the firmware package of your Dell     บ
ECHO บ 6Gbps SAS HBA controller to version %PkgVer%                   บ
ECHO บ                                                                   บ
...
ECHO.
ECHO Searching for compatible 6Gbps SAS HBA controllers on the system...
ECHO.
...
IF (%num1%)==(1) ECHO B1 Silicon present in controller (%num%).
...
ECHO ****************************************************************
ECHO   %NumFlashed%  6Gbps SAS HBA controller(s) successfully flashed
ECHO ****************************************************************
ECHO.
GOTO END
...
ECHO.
ECHO **********************************************************
ECHO No compatible 6Gbps SAS HBA controllers were identified or 
